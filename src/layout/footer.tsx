...
import { Icon, Button, Segment, Header, List, Image, Responsive } from 'semantic-ui-react';
    ...
    render() {
        return (
            <Segment.Group attached='bottom'>
                ...
                >
                    <Header as='h6' inverted style={{ textAllign: 'center', marginRight: '150px', padding: 'none', marginBottom: '0%', marginTop: '50px' }}>Powered by</Header>
                    <Image centered src={require('../assets/images/rr.png')} size='small'/>
                    <List floated='right' inverted tyle={{ marginTop: '0%' }}>
                        <List.Item>
                            <Header as='h5' inverted>Social</Header>
                        </List.Item>
                        <List.Item>
